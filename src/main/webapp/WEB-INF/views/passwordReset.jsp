                ...
                <div>
                    ...
                    <form method="post" action="${pageContext.request.contextPath}/siva/attempt-reset" id="resetForm">
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="contraseña" name="contra" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;" pattern="[A-Za-z0-9]{4,12}" title="La contraseña debe llevar de 4-12 digitos, sin utilizar simbolos." autocomplete="off" required>
                        </div>
                        <div class="form-group" id="confirmar-contra-group">
                            ...
                            <input type="password" class="form-control" id="confirmar-contraseña" name="contra2" placeholder="&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;&#9679;"  pattern="[A-Za-z0-9]{4,12}" title="La contraseña debe llevar de 4-12 digitos, sin utilizar simbolos." autocomplete="off" required>
